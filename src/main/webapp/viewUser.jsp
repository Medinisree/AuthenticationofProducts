...
<tr>
<td width="280"><%= i %></td>
<td width="280"><%=resultSet.getString("fname") %></td>
<td width="280"><%=resultSet.getString("lname") %></td>

<td width="280"><%=resultSet.getString("age") %></td>
<td width="280"><%=resultSet.getString("gender") %></td>
<td width="280"><%=resultSet.getString("mail") %></td>
<td width="280"><%=resultSet.getString("mobileNo") %></td>
</tr>
<%
}
connection.close();
